...
public class AnimatedSpriteRoot {
    ...
    protected AnimatedSpriteRoot(String ID, BufferedImage image, int width, int height, int x, int y, int dx, int dy, int frameCount, int sourceTargetFps, int destRenderFps, boolean zigzag) {
        id = ID;
        this.width = width;
        this.height = height;
        this.x = x;
     ...
     */
    public static AnimatedSpriteRoot registerAnimatedSprite(String id, BufferedImage image, int width, int height, int x, int y, int dx, int dy, int frameCount, int sourceTargetFps, int destRenderFps, boolean zigzag) {
        if (animatedSpriteRoots.containsKey(id)) {
            throw new IllegalArgumentException("ID already exists");
        }

        var root = new AnimatedSpriteRoot(id, image, width, height, x, y, dx, dy, frameCount, sourceTargetFps, destRenderFps, zigzag);
