...
public class AnimatedSpriteRoot {
     ...
     */
    public static void registerAnimatedSprite(String id, BufferedImage image, int width, int height, int x, int y, int dx, int dy, int frameCount, int sourceTargetFps, int destRenderFps, int repeat, boolean zigzag) {
